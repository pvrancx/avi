...
'''Aprroximate Value Iteration on Mountaincar with k-nearest neighbours'''
...
# mountaincar simulator (adding option to set to random state)
class MountainCarSim(gym.envs.classic_control.MountainCarEnv):
    def set_state(self,state):
        self.state = state

# prototype for regresseor to use: 10-nearest neighbour with input scaling
